...
const INITIAL_MOCK_DATA = Array(6).fill(null).map((_, i) => ({
  id: `mock-id-${i}`,
  title: `Test ${i + 1}`,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 flex-1 content-start pb-20">
        ...
        {filteredData.length === 0 && (
          <div className="col-span-full py-12 text-center text-gray-500 bg-white rounded border border-dashed border-gray-300">
            {data.length === 0 
              ? "No Knowledge Bases found. Click 'Create New' to add one." 
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="flex items-center">
            ...
            <div className="flex border border-gray-200 rounded bg-white overflow-hidden">
              <button className="px-2 py-1 border-r border-gray-200 hover:bg-gray-50 text-gray-400" disabled>
              ...
              <button className="px-2 py-1 hover:bg-gray-50 text-gray-400" disabled>
                <ChevronRight className="w-4 h-4" />
              </button>
            </div>
          </div>
