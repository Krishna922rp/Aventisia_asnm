...
const CreateKBDrawer = ({ isOpen, onClose, onSave, editingItem }) => {
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-900 mb-2">
              ...
              <span className="text-gray-500 font-normal">
                {isEditing ? '(Cannot be edited)' : '(Cannot be edited later)'}
              </span>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <ChevronDown className="w-4 h-4 absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 pointerEvents-none" />
            </div>
          </div>
...
<ChevronDown className="w-4 h-4 absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />            </div>
          </div>
